...
public class JsonManager {
    ...
    // Reusable Gson instance configured with LocalDateTime and pretty printing
    ...
    public static Room[] loadRooms() {
        try {
            ...
            System.out.println("Cannot load rooms.json: " + e.getMessage());
            return new Room[0];
        }
    }
    ...
    public static void saveRooms(Room[] rooms) {
        try {
            ...
            System.out.println("Cannot save rooms.json: " + e.getMessage());
        }
    }
